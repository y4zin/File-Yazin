...
export type LocalOperation = "imported" | "merged" | "split" | "converted" | "ocr";
export type ProjectOperation = "merge" | "split" | "convert" | "ocr";
...
export type LocalSettings = { maxMergeMb: number; splitTextLines: number; softDark: boolean };
